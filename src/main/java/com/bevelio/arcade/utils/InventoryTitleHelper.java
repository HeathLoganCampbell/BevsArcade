...
public class InventoryTitleHelper {
	 ...
	 */
	public static void sendInventoryTitle(Player player, String title, int size) {
		checkNotNull(player, "player");
		
		try {
			sendInventoryTitle0(player, title, size);
		} catch (Exception e) {
			e.printStackTrace();
		}
	}
	public static void sendInventoryTitle(Player player, String title) {
		...
		try {
			sendInventoryTitle0(player, title, -1);
		} catch (Exception e) {
			e.printStackTrace();
		}
	}

	private static void sendInventoryTitle0(Player player, String title, int size) throws Exception {
	...
	private static void sendPacket18(Object nms_playerConnection, Object nms_EntityPlayer, Object nms_Container, int windowId, Inventory inventory, String title, int size) throws Exception {
		if (c_PacketOpenWindow == null) {
